...
const ROUTING_PATH = "/itemList";

const ITEM_LIST = gql`
  query ItemList(
    $limit: Int
    $offset: Int
    $orderBy: inp_ItemOrderBy
    $filter: [inp_ItemFilterCondition]
  ) {
...
const ItemList = observer((props: EntityListProps<Item>) => {
  ...
  return (
    <DataTable
      ...
      columnDefinitions={["active", "age", "amount", "name"]}
